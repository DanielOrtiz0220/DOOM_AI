...
def train_model(model_path):
    ...
    for episode in range(TOTAL_EPISODES):
        ...
        while step < MAX_STEPS and not done:
            ...
            #Save the model weights every 200 epsidoes
            if episode % 200 == 0:
                conv_dqn.save("basic_dqn_defend_line.h5")
                print(f"Saved model: {episode} ; score: {game.get_total_reward()}")
    game.close()


@main.command()
@click.option("--model-path", default="basic_dqn_defend.h5")
